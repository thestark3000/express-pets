    ...
    try {
        const promise1 = transport.sendMail({
            ...
            html: ` <h3 style="color: purple; font-size: 30px; font-weight: normal">Thank You!</h3>
                    <p>We appreciate your interest in ${doesPetExist.name}, and one of our staff members will contact you shortly! Below is a copy of the message you sent for your personal records:</p>
